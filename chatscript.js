...
function generateNextOptionButtons(options) {
    ...
    if(options.length !== 0) {
        var messageParagraph = document.createElement('p');
        //messageParagraph.textContent = "Others:";
        optionsContainer.appendChild(messageParagraph);
...
function updatedUI(response) {
    ...
    if(response.nextEvent=='endMed')
    {
        ...
        document.getElementById('end-display').innerHTML= "<br><br><br><br><br><br><br><br><br><br><br><br><p>Thank you for using Wellness Chatbot. Please note, it may provide incorrect information<p>";
